                             ...
                             <div className="col-lg-8">
                                 <div className="row gx-5 row-cols-1 row-cols-md-2">
                                     <div className="col mb-5 h-100">
                                         <div className="feature bg-info bg-gradient text-white rounded-3 mb-3"><i className="bi bi-collection"></i></div>
                                     ...
                                     <div className="col mb-5 h-100">
                                         <div className="feature bg-info bg-gradient text-white rounded-3 mb-3"><i className="bi bi-building"></i></div>
                                         <h2 className="h5">Featured title</h2>
                                         <p className="mb-0">Paragraph of text beneath the heading to explain the heading. Here is just a bit more text.</p>
                                     </div>
                                     <div className="col mb-5 mb-md-0 h-100">
                                         <div className="feature bg-info bg-gradient text-white rounded-3 mb-3"><i className="bi bi-toggles2"></i></div>
                                         <h2 className="h5">Featured title</h2>
                                         <p className="mb-0">Paragraph of text beneath the heading to explain the heading. Here is just a bit more text.</p>
                                     </div>
                         ...
                         <div className="row gx-5">
                             <div className="col-lg-4 mb-5">
                                 <div className="card h-100 shadow border-0">
                                     ...
                                     <div className="card-body p-4">
                                         <div className="badge bg-info bg-gradient rounded-pill mb-2">News</div>
                             ...
                             <div className="col-lg-4 mb-5">
                                 <div className="card h-100 shadow border-0">
                                     ...
                                     <div className="card-body p-4">
                                         <div className="badge bg-info bg-gradient rounded-pill mb-2">Media</div>
