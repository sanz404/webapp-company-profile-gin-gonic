                                        ...
                                        <form autoComplete="off">
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <div className="input-group mb-3">
                                                    ...
                                                    <input type="text" defaultValue={this.state.username} className="form-control is-invalid"/>
                                            ...
                                            <button type="submit" className="btn btn-success w-100" data-bs-toggle="tooltip" data-bs-placement="top" title="Sign up for an account">
                                                <i className="fas fa-sign-in"></i>&nbsp;Sign up for an account
                                            </button>
